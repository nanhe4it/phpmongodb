...
<div class="btn-toolbar">
    ...
    <a class="btn <?php echo $this->application->layout==='import'?'active':'';?>" href="<?php echo Theme::URL('Collection/Import',array('db'=>$this->db,'collection'=>$this->collection)); ?>">Import</a>
